...
public class WordCountImproved {
  ...
  public static class TokenizerMapper
    ...
    public void map(Object key, Text value, Context context
      ...
      StringTokenizer itr = new StringTokenizer(value.toString().toLowerCase()); // Convert to lowercase
      while (itr.hasMoreTokens()) {
        String token = itr.nextToken().replaceAll("^[^a-zA-Z]+|[^a-zA-Z]+$", ""); // Remove non-letter chars
